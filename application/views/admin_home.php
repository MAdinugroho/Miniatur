    ...
    <div class="row">
      ...
      <div class="box">
            <div class="box-header">
              <center><h2 >Daftar Peserta Lomba Miniatur Undip 2017</h2></center><br>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">
                      <center>Perguruan Tinggi</center>
                  </th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">
                      <center>Alamat Perguruan Tinggi</center>
                  </th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">
                      <center>Daftar Anggota</center>
                  </th>
                </tr>
                </thead>
                ...
                <?php $no = 1; foreach($peserta->result() as $list){ ?>
                ...
                <form action="" method="post">
                  ...
                  <td><?php echo $list->ptasal ?></td>
                  <td><?php echo $list->ptalamat ?></td>
                  <td><a class="btn btn-block btn-social btn-vk" href="<?php echo site_url('pesertalomba/').$list->nohp_ketua ?>" target="_blank"><i class="fa fa-user"></i> Lihat Anggota</a></i></a></td>
